...
struct TextureData {
	...
	TextureData(u8* pixels, i32 width, i32 height, i32 channels)
	...
	constexpr TextureData(TextureData&& other) noexcept
	...
	[[nodiscard]] static TextureData load(const std::string_view path);
